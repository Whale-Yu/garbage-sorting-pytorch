...
if __name__ == "__main__":
    # 待预测图片路径
    img_path = './input/pre_img1/trash/img.png'
    model_file_path = './model/resnet18_wandb_2.pth'

    dataset_path = './dataset/image'
    pre_dataset_path = './input/pre_img1'
    ...
    pre_dataset = ImageFolder(pre_dataset_path, transform=transform)
    ...
    #         true_num1 += 1
    #     print(f'真实:{dataset[idx][1]}-{real_cls1} \t\t\t\t 预测:{cls.numpy()[0]}-{pre_cls1} \t\t\t\t 概率:{p.numpy()[0]}')
